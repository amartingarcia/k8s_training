...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.s="GTM-PLVRLF";Vc.Cb="340";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.js";var $c=Zc,bd=null,cd=null,dd=null,ed="//www.googletagmanager.com/a?id="+Vc.s+"&cv=102",fd={},gd={},hd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var id={},jd=function(a,b){id[a]=id[a]||[];id[a][b]=!0},kd=function(a){for(var b=[],c=id[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
b);return F[a]},ek=function(a,b,c){return Gf(a,b,void 0===c?!0:!!c)},fk=function(a,b){if(Wd()){b&&I(b)}else kc(a,b)},gk=function(a){return!!uj(a,"init",!1)},hk=function(a){sj(a,"init",!0)},ik=function(a,b){var c=(void 0===b?0:b)?"www.googletagmanager.com/gtag/js":$c;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";S(Q("https://","http://",c))},jk=function(a,b){var c=a[b];return c};var kk=nj.Dg;var Hk=new xa;function Ik(a,b){function c(h){var k=af(h),l=$e(k,"protocol"),m=$e(k,"host",!0),n=$e(k,"port"),r=$e(k,"path").toLowerCase().replace(/\/$/,"");if(void 0===l||"http"==l&&"80"==n||"https"==l&&"443"==n)l="web",n="default";return[l,m,n,r]}for(var d=c(String(a)),e=c(String(b)),f=0;f<d.length;f++)if(d[f]!==e[f])return!1;return!0}
...
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=qj(c,"gtm.click");ck(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!gk("cl")){var c=W("document");mc(c,"click",a,!0);hk("cl")}I(b.vtp_gtmOnSuccess)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return ek(a.vtp_name,U("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
Z.a.awc=["nonGoogleScripts"],function(){var a=!1,b=function(c){if(a)c.vtp_gtmOnSuccess();else{var d=c.vtp_channel||"na",e,f,h;if(c.vtp_group&&0<=c.vtp_group.indexOf(":")){e=c.vtp_group;for(var k=c.vtp_group.split("|"),l=[],m=h=0;m<k.length;m++)if(k[m]){var n=k[m].split(":");if(2==n.length&&n[0]&&n[1]){var r=parseFloat(n[1]);isNaN(r)||(l.push(X(n[0])+":"+r),h+=r)}}f=l.join("|")}else h=c.vtp_orderValue||0,e=(c.vtp_group||"DEFAULT")+":"+h,f=X(c.vtp_group||"DEFAULT")+":"+X(h);var t=c.vtp_testMode?"1":
"0";try{var p=["merchant="+X(c.vtp_merchantId),"ref="+X(c.vtp_orderRef),"amount="+X(h),"parts="+f,"ch="+X(d),"testmode="+t];c.vtp_currency&&p.push("cr="+X(c.vtp_currency));c.vtp_discountCode&&p.push("vc="+X(c.vtp_discountCode));Ok("https://www.awin1.com/sread.img?tt=ns&tv=2&"+p.join("&"))}catch(v){}try{var u={};u.orderRef=c.vtp_orderRef;u.amount=h;c.vtp_currency&&(u.currency=c.vtp_currency);u.parts=e;c.vtp_discountCode&&(u.voucher=c.vtp_discountCode);u.channel=d;u.test=t;F.AWIN={Tracking:{Sale:u}};
S("https://www.dwin1.com/"+c.vtp_merchantId+".js",c.vtp_gtmOnSuccess,c.vtp_gtmOnFailure);a=!0}catch(v){I(c.vtp_gtmOnFailure)}}};Z.__awc=b;Z.__awc.b="awc";Z.__awc.g=!0;Z.__awc.priorityOverride=0}();
Z.a.awj=["nonGoogleScripts"],function(){var a=!1,b=function(c){if(a)c.vtp_gtmOnSuccess();else try{S("https://www.dwin1.com/"+c.vtp_merchantId+".js",c.vtp_gtmOnSuccess,c.vtp_gtmOnFailure),a=!0}catch(d){I(c.vtp_gtmOnFailure)}};Z.__awj=b;Z.__awj.b="awj";Z.__awj.g=!0;Z.__awj.priorityOverride=0}();
Z.a.fsl=[],function(){function a(){var e=W("document"),f=c(),h=HTMLFormElement.prototype.submit;mc(e,"click",function(k){var l=k.target;if(l&&(l=sc(l,["button","input"],100))&&("submit"==l.type||"image"==l.type)&&l.name&&oc(l,"value")){var m;l.form?l.form.tagName?m=l.form:m=G.getElementById(l.form):m=sc(l,["form"],100);m&&f.store(m,l)}},!1);mc(e,"submit",function(k){var l=k.target;if(!l)return k.returnValue;var m=k.defaultPrevented||!1===k.returnValue,n=b(l)&&!m,r=f.get(l),t=!0;if(d(l,function(){if(t){var p;
